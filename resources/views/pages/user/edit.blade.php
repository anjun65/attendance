                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                          ...
                          <div class="sm:col-span-2">
                            ...
                            <div class="relative mt-2.5">
                              ...
                              <select id="roles" name="roles" class="ring-1 ring-inset ring-gray-300 shadow-sm h-full w-full rounded-md border-0 bg-transparent bg-none text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm">
